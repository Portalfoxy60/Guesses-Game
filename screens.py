...
class ScreenShower:
    ...
    def show_category_selection_screen(self):
        for button in self.button_massive:
            button.hide()
        self.screen.fill(self.fill)
        title_font = self.pygame.font.SysFont("sans-serif", 80)
    ...
    def game_screen(self, categoryId):
        ...
        score_font = pygame.font.SysFont("sans-serif", 120)
    ...
    def timer(self, surface, score_surface):
        ...
        while self.run:
            time_font = pygame.font.SysFont("sans-serif", 120)
